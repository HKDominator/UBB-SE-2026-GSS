...
public interface IAnnouncementService
{
    ...
    Task UpdateAnnouncementAsync(int announcementId, string newMessage, int userId);
    Task DeleteAnnouncementAsync(int annId, int userId);
    Task PinAnnouncementAsync(int annId, int eventId, int userId);
    Task MarkAsReadAsync(int annId, int userId);
    Task<List<AnnouncementReadReceipt>> GetReadReceiptsAsync(int annId, int userId);
